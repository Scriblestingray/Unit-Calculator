...
int CompareUnitOrder(const void *item1, const void *item2)
{
    ...
    return pair1->unit < pair2->unit ? -1 : pair1->unit > pair2->unit ? 1
                                                                      : 0;
}
...
Result AddUnitless(Number num1, Number num2)
{
    ...
    unsigned long long base =
        signs_unequal ? (base_flip_sign ? num2.base - num1.base : num1.base - num2.base)
                      : num1.base + num2.base;
    ...
    unsigned long long numerator = signs_unequal ? (frac_flip_sign ? num2_num - num1_num : num1_num - num2_num) : num1_num + num2_num;
